...
exports.topologicalSortClasses =
    exports.classesConnectedToBaseContract =
    exports.classesConnectedToBaseContracts =
    exports.filterHiddenClasses =
        void 0
...
const filterHiddenClasses = (umlClasses, options) => {
    return umlClasses.filter(
        (u) =>
            (u.stereotype === umlClass_1.ClassStereotype.Enum &&
                !options.hideEnums) ||
            (u.stereotype === umlClass_1.ClassStereotype.Struct &&
                !options.hideStructs) ||
 ...
 */
const classesConnectedToBaseContracts = (
    umlClasses,
    baseContractNames,
    depth,
) => {
    ...
    for (const baseContractName of baseContractNames) {
        filteredUmlClasses = {
            ...filteredUmlClasses,
            ...(0, exports.classesConnectedToBaseContract)(
                umlClasses,
                baseContractName,
 ...
 * @return filteredUmlClasses list of UML classes of type `UMLClass`
 */
const classesConnectedToBaseContract = (
    umlClasses,
    baseContractName,
    weightedDirectedGraph,
    depth = 1000,
...
function loadWeightedDirectedGraph(umlClasses) {
    ...
    for (const sourceUmlClass of umlClasses) {
        for (const association of Object.values(sourceUmlClass.associations)) {
            ...
            const targetUmlClass = (0, associations_1.findAssociatedClass)(
                association,
                sourceUmlClass,
                umlClasses,
            )
            ...
            weightedDirectedGraph.addEdge(
                new js_graph_algorithms_1.Edge(
                    sourceUmlClass.id,
                    targetUmlClass.id,
                    1,
                ),
...
const topologicalSortClasses = (umlClasses) => {
    ...
    const topologicalSort = new js_graph_algorithms_1.TopologicalSort(
