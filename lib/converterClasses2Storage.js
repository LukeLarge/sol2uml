...
exports.addDynamicVariables =
    exports.findDimensionLength =
    exports.calcSectionOffset =
    exports.isElementary =
    exports.calcStorageByteSize =
    exports.parseStorageSectionFromAttribute =
    exports.optionStorageVariables =
    exports.convertClasses2StorageSections =
    exports.StorageSectionType =
        void 0
 ...
 */
const convertClasses2StorageSections = (
    contractName,
    umlClasses,
    arrayItems,
    contractFilename,
...
const parseVariables = (
    ...
    newInheritedContracts.forEach((parent) => {
        const parentClass = (0, associations_1.findAssociatedClass)(
            parent,
            umlClass,
            umlClasses,
        )
    ...
    umlClass.attributes.forEach((attribute) => {
        ...
        const { size: byteSize, dynamic } = (0, exports.calcStorageByteSize)(
            attribute,
            umlClass,
            umlClasses,
        )
        ...
        const references = noExpandVariables.includes(attribute.name)
            ? undefined
            : (0, exports.parseStorageSectionFromAttribute)(
                  attribute,
                  umlClass,
                  umlClasses,
                  storageSections,
    ...
    storageSection.variables.forEach((variable) => {
        ...
        if (referenceStorageSection) {
            ...
            if (!variable.dynamic) {
                ...
                variable.attributeType === umlClass_1.AttributeType.Array
            ) {
                // attribute is a dynamic array
                referenceStorageSection.offset = (0, exports.calcSectionOffset)(
                    variable,
 ...
 */
const parseStorageSectionFromAttribute = (
    attribute,
    umlClass,
    otherClasses,
    storageSections,
    ...
    if (attribute.attributeType === umlClass_1.AttributeType.Array) {
        ...
        const { size: arrayItemSize, dynamic: dynamicBase } = (0,
        exports.calcStorageByteSize)(baseAttribute, umlClass, otherClasses)
        ...
        if (baseAttributeType !== umlClass_1.AttributeType.Elementary) {
            ...
            references = (0, exports.parseStorageSectionFromAttribute)(
                baseAttribute,
                umlClass,
                otherClasses,
                storageSections,
    ...
    if (attribute.attributeType === umlClass_1.AttributeType.Mapping) {
        ...
        if (
            result !== null &&
            result[1] &&
            !(0, exports.isElementary)(result[1])
        ) {
...
const findTypeClass = (userType, attribute, umlClass, otherClasses) => {
    ...
    const typeClass = (0, associations_1.findAssociatedClass)(
        association,
        umlClass,
        otherClasses,
    )
...
const calcStorageByteSize = (attribute, umlClass, otherClasses) => {
    if (
        attribute.attributeType === umlClass_1.AttributeType.Mapping ||
    ...
    if (attribute.attributeType === umlClass_1.AttributeType.Array) {
        ...
        while (dimension && dimension !== '') {
            const dimensionNum = (0, exports.findDimensionLength)(
                umlClass,
                dimension,
                otherClasses,
            )
        ...
        if ((0, exports.isElementary)(type)) {
            ...
            ;({ size: elementSize } = (0, exports.calcStorageByteSize)(
                elementAttribute,
                umlClass,
                otherClasses,
            ))
            ...
            case umlClass_1.ClassStereotype.Struct:
                ...
                attributeTypeClass.attributes.forEach((structAttribute) => {
                    ...
                    if (
                        ...
                        umlClass_1.AttributeType.Array
                    ) {
...
const calcSectionOffset = (variable, sectionOffset = '0') => {
    if (variable.dynamic) {
        const hexStringOf32Bytes = (0, utils_1.hexZeroPad)(
            ethers_1.BigNumber.from(variable.fromSlot)
                .add(sectionOffset)
                .toHexString(),
            32,
        )
    ...
    return ethers_1.BigNumber.from(variable.fromSlot)
        .add(sectionOffset)
        .toHexString()
}
 ...
 */
const calcGetValue = (attributeType, mapping) =>
    mapping === false && attributeType !== umlClass_1.AttributeType.Mapping
/**
 ...
 */
const addDynamicVariables = async (
    storageSection,
    storageSections,
    url,
    contractAddress,
    ...
    for (const variable of storageSection.variables) {
        try {
            ...
            if (variable.type === 'string' || variable.type === 'bytes') {
                ...
                if (size > 31) {
                    ...
                    const newStorageSection = {
                        ...
                        offset: (0, exports.calcSectionOffset)(
                            variable,
                            storageSection.offset,
                        ),
                        type:
                    ...
                    await (0, slotValues_1.addSlotValues)(
                        url,
                        contractAddress,
                        newStorageSection,
                        arrayItems,
            ...
            await (0, exports.addDynamicVariables)(
                referenceStorageSection,
                storageSections,
                url,
                contractAddress,
            ...
            const arrayLength = ethers_1.BigNumber.from(
                variable.slotValue,
            ).toNumber()
            if (arrayLength > 1) {
