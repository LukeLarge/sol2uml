 ...
 */
export declare const convertClasses2StorageSections: (
    contractName: string,
    umlClasses: UmlClass[],
    arrayItems: number,
...
export declare const optionStorageVariables: (
    contractName: string,
    slotNames?: {
        name: string
        offset: string
 ...
 */
export declare const parseStorageSectionFromAttribute: (
    attribute: Attribute,
    umlClass: UmlClass,
...
export declare const calcStorageByteSize: (
    attribute: Attribute,
    umlClass: UmlClass,
    otherClasses: readonly UmlClass[],
) => {
...
export declare const calcSectionOffset: (
    variable: Variable,
    sectionOffset?: string,
) => string
export declare const findDimensionLength: (
    umlClass: UmlClass,
    dimension: string,
    otherClasses: readonly UmlClass[],
) => number
 ...
 */
export declare const addDynamicVariables: (
    storageSection: StorageSection,
    storageSections: StorageSection[],
    url: string,
