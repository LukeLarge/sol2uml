...
export declare const parseUmlClassesFromFiles: (
    filesOrFolders: readonly string[],
    ignoreFilesOrFolders: readonly string[],
    subfolders?: number,
) => Promise<UmlClass[]>
export declare function getSolidityFilesFromFolderOrFiles(
    folderOrFilePaths: readonly string[],
    ignoreFilesOrFolders: readonly string[],
    subfolders?: number,
): Promise<string[]>
export declare function getSolidityFilesFromFolderOrFile(
