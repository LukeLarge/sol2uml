...
export declare const compareVerifiedContracts: (
    addressA: string,
...
export declare const compareVerified2Local: (
    addressA: string,
    aEtherscanParser: EtherscanParser,
    fileOrBaseFolders: string[],
    options: DiffOptions,
) => Promise<void>
export declare const compareFlattenContracts: (
    addressA: string,
    addressB: string,
    aEtherscanParser: EtherscanParser,
    bEtherscanParser: EtherscanParser,
...
export declare const displayFileDiffs: (
    fileDiffs: DiffFiles[],
    options?: {
        lineBuffer?: number
        aFile?: string
