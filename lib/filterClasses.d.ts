 ...
 */
export declare const filterHiddenClasses: (
 ...
 */
export declare const classesConnectedToBaseContracts: (
    umlClasses: readonly UmlClass[],
 ...
 * @return filteredUmlClasses list of UML classes of type `UMLClass`
 */
export declare const classesConnectedToBaseContract: (
    umlClasses: readonly UmlClass[],
...
export declare const topologicalSortClasses: (
    umlClasses: readonly UmlClass[],
) => UmlClass[]
