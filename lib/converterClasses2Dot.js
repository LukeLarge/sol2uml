 ...
 */
function convertUmlClasses2Dot(
    umlClasses,
...
label="${codeFolder}"`
        ...
        dotString += (0, converterClass2Dot_1.convertClass2Dot)(
            umlClass,
            classOptions,
        )
    }
...
function addAssociationToDot(
        ...
        (classOptions.hideLibraries &&
            (sourceUmlClass.stereotype === umlClass_1.ClassStereotype.Library ||
                targetUmlClass.stereotype ===
                    umlClass_1.ClassStereotype.Library)) ||
        (classOptions.hideInterfaces &&
            (targetUmlClass.stereotype ===
                umlClass_1.ClassStereotype.Interface ||
                sourceUmlClass.stereotype ===
                    umlClass_1.ClassStereotype.Interface)) ||
        (classOptions.hideAbstracts &&
            (targetUmlClass.stereotype ===
                umlClass_1.ClassStereotype.Abstract ||
                sourceUmlClass.stereotype ===
                    umlClass_1.ClassStereotype.Abstract)) ||
    ...
    if (
        association.referenceType == umlClass_1.ReferenceType.Memory ||
