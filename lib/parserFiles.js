...
exports.isFolder =
    exports.isFile =
    exports.readFile =
    exports.parseSolidityFile =
    exports.getSolidityFilesFromFolderOrFile =
    exports.getSolidityFilesFromFolderOrFiles =
    exports.parseUmlClassesFromFiles =
        void 0
...
const parseUmlClassesFromFiles = async (
    filesOrFolders,
    ...
    for (const file of files) {
        ...
        const newUmlClasses = (0, converterAST2Classes_1.convertAST2UmlClasses)(
            node,
            relativePath,
            [],
            true,
...
async function getSolidityFilesFromFolderOrFiles(
    folderOrFilePaths,
    ignoreFilesOrFolders,
    subfolders = -1,
) {
...
function getSolidityFilesFromFolderOrFile(
    folderOrFilePath,
    ignoreFilesOrFolders = [],
    depthLimit = -1,
) {
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            if (folderOrFile.isDirectory()) {
                ...
                const filter = (file) => {
                    return !ignoreFilesOrFolders.includes(
